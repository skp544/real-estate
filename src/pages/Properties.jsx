...
import { Header, PropertiesGridContainer, Footer } from "../components";
import { createClient } from "@supabase/supabase-js";
import { ListBullet, Square4 } from "../assets";
        ...
        <div className=" flex flex-row items-center justify-start">
          <div className="flex flex-row flex-wrap items-end justify-start gap-[16px]">
            <div className="flex flex-row items-start justify-start gap-[8px]">
              <img className=" w-6 h-6" alt="" src={ListBullet} />
              <img className=" w-6 h-6" alt="" src={Square4} />
            </div>
